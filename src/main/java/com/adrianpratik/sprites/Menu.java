...
public class Menu {
    ...
    private ImageView play, titleGame, exit, game_intro;
...
//        exit.setOnMouseExited(event -> exit.setImage(new Image("images/quit_hover.png")));
        ...
        game_intro = new ImageView("images/game_pase.gif");
        game_intro.setStyle("-fx-background-color: transparent; ");
//        game_intro.setOnMouseEntered(event -> exit.setImage(new Image("images/quit_hover.png")));
//        game_intro.setOnMouseExited(event -> exit.setImage(new Image("images/quit_hover.png")));
        exit.setLayoutX(465);
        exit.setLayoutY(450);

        groupMenu = new Group();
        groupMenu.getChildren().addAll(play, exit, titleGame, game_intro);
    }
    ...
    public void draw() {
        ...
        // Boton jugar
        MainWindow.getGraphicsContext().drawImage(play.getImage(), 900*MainWindow.diferenceWidth, 500*MainWindow.diferenceHeight, 103*MainWindow.diferenceWidth, 60*MainWindow.diferenceHeight);
        ...
        // Como se juega
        MainWindow.getGraphicsContext().drawImage(game_intro.getImage(), 30*MainWindow.diferenceWidth, 900*MainWindow.diferenceHeight, 300*MainWindow.diferenceWidth, 60*MainWindow.diferenceHeight);
    }
